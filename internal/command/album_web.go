...
func CmdAlbumWeb() cli.Command {
	return cli.Command{
		Name:      "albumw",
		Usage:     "个人相册",
		UsageText: cmder.App().Name + " albumw",
		Category:  "阿里云盘",
...
示例:
    ...
    新建相簿，名称为：我的相簿2022
    aliyunpan albumw new "我的相簿2022"

    新建相簿，名称为：我的相簿2022，描述为：存放2022所有文件
    aliyunpan albumw new "我的相簿2022" "存放2022所有文件"
`,
				Action: func(c *cli.Context) error {
					if config.Config.ActiveUser() == nil {
						fmt.Println("未登录账号")
...
示例:
    ...
    删除名称为"我的相簿2022"的相簿
    aliyunpan albumw rm "我的相簿2022"

    删除名称为"我的相簿2022-1" 和 "我的相簿2022-2"的相簿
    aliyunpan albumw rm "我的相簿2022-1" "我的相簿2022-2"
`,
				Action: func(c *cli.Context) error {
					if config.Config.ActiveUser() == nil {
						fmt.Println("未登录账号")
...
示例:
    ...
    aliyunpan albumw rename "我的相簿2022" "我的相簿2022-new"
`,
				Action: func(c *cli.Context) error {
					if config.Config.ActiveUser() == nil {
						fmt.Println("未登录账号")
...
示例:
    ...
    展示相簿中文件"我的相簿2022"
    aliyunpan albumw list-file "我的相簿2022"
`,
				Action: func(c *cli.Context) error {
					if config.Config.ActiveUser() == nil {
						fmt.Println("未登录账号")
...
示例:
    ...
    aliyunpan albumw rm-file 我的相簿2022 1.png 2.png
`,
				Action: func(c *cli.Context) error {
					if config.Config.ActiveUser() == nil {
						fmt.Println("未登录账号")
...
示例:
    ...
    aliyunpan albumw add-file 我的相簿2022 1.png 2.png

    增加当前目录下的 myFolder 文件夹下所有文件到相簿 "我的相簿2022" 中
    aliyunpan albumw add-file 我的相簿2022 myFolder
`,
				Action: func(c *cli.Context) error {
					if config.Config.ActiveUser() == nil {
						fmt.Println("未登录账号")
...
示例:
    ...
    aliyunpan albumw download-file 我的相簿2022
