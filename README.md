...
┌───────────────────────────────────────────────────────────────────────────────────────────────┐
│总速度: 341.59 KB/s | 文件: 0/7 | 失败: 0 | 状态: 下载中 | 已用时间: 9s | 剩余时间: -                │
│总进度: [===>                                                       ]   7.4% (896.00KB/11.83MB) │
│───────────────────────────────────────────────────────────────────────────────────────────────│
│ 1. IMG_0005.JPG                            [============>       ]  66.9% 0 B/s        -       │
│ 2. IMG_0007.JPG                            [============>       ]  67.3% 0 B/s        -       │
│ 3. IMG_0009.JPG                            [                    ]   0.0% 等待中       -        │
│───────────────────────────────────────────────────────────────────────────────────────────────│
│[10:39:24] [0] 当前文件下载最大并发量为: 2, 单文件下载分片线程数为: 1, 下载缓存为: 64.00KB              │
│[10:39:27] [2] 加入下载队列: /photo/p/IMG_0007.JPG                                               │
│[10:39:27] [2] ---- 文件ID: 67dfe476a7573e76a2034626bd013f36581296ed 文件名: IMG_0007.JPG 文...  │
│[10:39:27] [3] 准备下载: /photo/p/IMG_0007.JPG                                                  │
│[10:39:27] [2] 将会下载到路径: /Users/tickstep/Downloads/4d001d48564f43b3bc5662874f04bbe6/ph...  │
│[10:39:28] [2] 下载开始                                                                         │
└───────────────────────────────────────────────────────────────────────────────────────────────┘
```
